...
% Without insertions/deletions, sequence simulation is very much limited. 
% This is one reason why so many sequence simulators with indels have been developed recently. 
% Since BEAGLE includes an indel model, I assume piBUSS can also include indels in its simulation. 
% If so, I highly suggest the authors to incorporate this option.
% 
% 
% We believe the reviewer is referring to the stochastic Dollo model -- this feature is indeed high on the TODO list of {\bussname} and will be implemented in a future release of the software.
...
% rewrite, more responsive, instant color changes without re-computing
