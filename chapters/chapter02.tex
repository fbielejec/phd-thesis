...
\myedit{svsixteen}{
This means they assumed that each geographic region and influenza season is considered to be a discrete character, for example samples collected from October 2002 to February 2003 in New York as assigned discrete state labelled ``New York 2003'' \citep{Bahl2011}.
}
