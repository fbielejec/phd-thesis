...
Bayesian evolutionary analysis by sampling trees (BEAST) software \citep{Drummond2012}, which is co-developed in our research group is build around the advances described in Subsections~\ref{sub:epidemiology}-\ref{sub:molecular_clock}.
...
% By assuming either strict or relaxed clock BEAST allows for sampling rooted and time-measured phylogenies,  
