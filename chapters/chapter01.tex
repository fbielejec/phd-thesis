...
\caption{
{ \footnotesize 
%PL: the units of the time scales are hardly visible; please alo change 'Heterogenous' to Dated tips.
...
These assumptions are mainly considered to reduce the number of free parameters of the models and ease the computational and mathematical tractability.
...
Clear and intuitive visualizations are an important aspect of every analysis \citep{Hadley2010}, but this is far from trivial for the estimates we obtain.
