...
%GB: this next short paragraph is strangely located here ...
...
The prior information is then combined with the likelihood of the data $P\left(\theta|\mathbf{X}\right)$ to form the posterior, via Bayes' theorem (Equation~(\ref{eq:bayesian1})).
