...
%PL: why not use a simpler tree for fewer taxa, not necessarily with dated tips, where you indicate the terms you describe. For example the sample tree for figure 1.10, but without node and branch numbering, and taxon 1, taxon 2,.. as tip labels
