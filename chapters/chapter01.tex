...
{\bf Different tree structures imposed by molecular clock assumptions for organisms evolving at different rates.} The tree on the right represents an evolutionary history of slowly evolving organisms, and has tips that are all aligned at $t=0$. Conversely the tree on the left represents an evolutionary history of rapidly evolving organisms with samples at different points in time, which provide temporal information to calibrate the molecular clock.
}% END: footnotesize
}
...
%Some of the mutations may be unobserved. %PL: All of the mutations are unobserved
...
%PL: Not sure if you want to do a color page print for this figure; it could be black/white
