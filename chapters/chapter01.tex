...
\begin{equation}  
q_{\beta}\left(\theta\right)=P\left(\mathbf{X}\mid\theta,M\right)\times P\left(\theta\mid M\right).
\label{eq:ss_ps}
\end{equation}  
...
% When only modest computation is invested to keep marginal likelihood manageable for large data sets, the estimates may suffer from considerable variance, preventing an accurate comparison of two models.
