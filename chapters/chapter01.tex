...
%TODO:  how to accommodate time-stamped sequences
...
% evolution for the entire tree, μ, which gives the linear
% relationship between these two scales. The information
% that allows us to estimate μ, is provided by the differences
% in tip dates. Thus, for any given values of our parameters,
% T0 , T1 , T2 , T3 and μ, we can calculate the branch lengths
...
%TODO: briefly introduce, mg is later, show gy94 
