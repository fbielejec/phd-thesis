...
However to hardware limitations and problems with heat dissipation we are approaching the limit of how many transistors can be put into integrated circuits, which translates into CPU performance.
...
For practical purposes this meant that just by updating the hardware architecture and compilators we could tackle bigger problems without ever changing the code-base of the numerical programs.
...
Yet emerging areas of research, such as computational biology have all implications for algorithms and software development.
...
Yet to properly leverage these possibilities means that the burden is, at least partially, shifted from harware vendors to software developers.
...
\paragraph{}
GPUs \citep{Nickolls2008} have recently 


% Field-programmable gate arrays (FPGA, \citet{Kuon2008}).
