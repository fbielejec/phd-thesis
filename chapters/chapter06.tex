...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{first_draft}
\caption{
{ \footnotesize 
...
Traditionally a vast majority of programs were written as sequential, which work well for the scientific community for many years.
...
% two roads: many core an multi core
