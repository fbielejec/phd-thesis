...
%PL: added this below, check for references
...
%PL: incorporate the citations of this section
...
Our phylogenetic simulation software, $\pi$BUSS, presented in Chapter \ref{chap:pibuss} allows fabricating evolution under a variety of coalescent, nucleotide, amino-acid and codon substitution models, as well as diffusion models, combined with various molecular clock specifications.
...
Future releases of $\pi$BUSS will aim at implementation stochastic processes for indel evolution. % that option, starting with the stochastic Dollo model \citep{LeQuesne1974}.
...
%PL: whats the best and average in the plot; was it taken from somewhere -- in other words does it needs acknowledgements?
For practical purposes this meant that just by updating the hardware architecture and compilators %PL: compilers?
