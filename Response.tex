...
\\
I have now added a \emph{Markov models of codon evolution} subsection in the introductory chapter, which discusses the most popular codon model implementations (see Subsection ~\ref{sub:codon}).
...
\\
Corrected, see Subsection~\ref{sub:dated_trees}, which describes the methods used in BEAST to accommodate time-stamped sequences as a source of calibration for trees.
%
