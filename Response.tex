...
We now also entertain a numbe rof simulations which asses the impact of correcting for time-heterogeneity on tree reconstruction. 
...
\\
FB: I don't understand the comment, I though we explicitly say we use spring and summer as intervals?
